//loading jQueryScript and css for tooltip
var jQueryScript = document.createElement('script'); 
var styleCss = document.createElement('link'); 
jQueryScript.src ='https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js';
jQueryScript.type = "text/javascript";
//         styleCss.setAttribute({'href': 'https://guidedlearning.oracle.com/player/latest/static/css/stTip.css', 'rel': 'stylesheet', 'type': 'text/css'});
...
const OUTER_DIV = '<div  class="sttip"><div class="tooltip in"><div class="tooltip-arrow"></div><div class="tooltip-arrow second-arrow"></div><div class="popover-inner"></div></div></div>'


function addTip(actions, tips, tiplates, style, tipNumber){
        
        //parsing tip template and style
        var outerHTNL = $.parseHTML(OUTER_DIV);
        var tipHTML = $.parseHTML(tiplates.tip);
        var hoverTipHTML = $.parseHTML(tiplates.hoverTip);
        
        //onload showing the first tip                
        //inject div tip and hoverTip
        ...
        //inject step number + content + class
...
//                  console.log("YYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYYY", tips[tipNumber].classes)
//                  $(".prev-btn").addClass(tips[tipNumber].classes)


        //onclick X and onclick next
